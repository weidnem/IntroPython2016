...
# But take a look at the ord() and chr() functions, so you don't need to make 
# a string with the letters to get their index.

print("Caesar Cypher")

alphabet = ("abcdefghijklmnopqrstuvwxyz")
# You can do this with chr() and ord() instead
