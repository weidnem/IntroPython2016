...
def donor_total(index):
    total_donations = 0
    # BUG: in donor_total - IndexError: list index out of range
    for entry in donor_list[index][1]:
        total_donations += entry
...
def find_donor(str):
    ...
    return False # could be: return None
...
def mail_message(donor_info):
    ...
    Carl
    '''
    print(form.format(name=first_name, amount=donations)) # could be: return this
    # this returns *total* donations - not just last donation
    return
