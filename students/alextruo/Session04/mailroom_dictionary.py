...
#ordered_donors = OrderedDict(sorted(donors.items(), key=lambda t: t[0]))
#print(OrderedDict(sorted(donors.items(), key=lambda t: t[1])))
...
#If I choose‘Create a Report’ print a list of your donors, sorted by total historical donation amount.
    #print("\nThese are the donors: {}".format(ordered_donors ))
...
#If the user types a name in the list, use it.
            ...
            if type(donate) == int:
                ...
                We are so glad you could join as a donor!

                Your contribution makes things possible.
